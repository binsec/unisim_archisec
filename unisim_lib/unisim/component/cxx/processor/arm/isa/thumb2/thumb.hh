...
#ifndef __unisim_component_cxx_processor_arm_isa_thumb2_thumb_unisim__component__cxx__processor__arm__isa__thumb_HH__
#define __unisim_component_cxx_processor_arm_isa_thumb2_thumb_unisim__component__cxx__processor__arm__isa__thumb_HH__
...
struct Decoder
{
	...
	enum { little_endian = 1, alignment = 16, minsize = 16, maxsize = 32 };
	Decoder();
	virtual ~Decoder();
